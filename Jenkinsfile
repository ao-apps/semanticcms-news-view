...
binding.setVariable('upstreamProjects', [
  ...
  // No Jenkins: <groupId>net.sargue</groupId><artifactId>java-time-jsptags</artifactId>
  ...
  'model', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-news-model</artifactId>
  'servlet', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-news-servlet</artifactId>
  'taglib', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-news-taglib</artifactId>
